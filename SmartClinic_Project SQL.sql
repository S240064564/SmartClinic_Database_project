...
prescribed_medicine VARCHAR(150),
...
INSERT INTO Treatments (appointment_id, treatment_name, treatment_cost, prescribed_medicine) VALUES
(1, 'ECG and Consultation', 150.00, 'Aspirin 81mg'),
(2, 'Routine Pediatric Checkup', 100.00, 'Multi-Vitamins'),
(3, 'Cardiology Follow-up', 200.00, 'Beta Blockers'),
(4, 'Skin Rash Treatment', 120.00, 'Hydrocortisone Cream'),
(5, 'Joint Pain Examination', 180.00, 'Ibuprofen 400mg');
...
WHERE patient_id IN (
    ...
    WHERE t.prescribed_medicine = 'Aspirin 81mg'
);
